...
@Component({
  ...
  standalone: true,
  imports: [MatFormFieldModule, MatIconModule, MatInputModule, MatAutocompleteModule, ReactiveFormsModule, AsyncPipe],
...
export class DropdownUfComponent implements OnInit {
  ...
  private _filter(value: string): UnidadeFederativa[] {
    ...
    return this.options.filter(option => option.nome.toLocaleLowerCase().includes(filterValue));
  }
